...
Issues and specs for this repo live as GitHub issues in `mz038197/classroom-one-click-install`. Use the `gh` CLI for all operations.
...
Earlier work remains under `.scratch/` as read-only history. New issues, specs, and wayfinder tickets go to GitHub.
